...
\begin{frame}{Block-structured input matrices}
...
\begin{frame}{Multistate kinship models\fcite{adhikari_future_2025}}    
      \begin{figure}[!h]
      \centering
      \includegraphics[width =1\textwidth]{figures/kin_ageedu_gm_bothsex_Nepal.PNG}
     \end{figure}    
\end{frame}
