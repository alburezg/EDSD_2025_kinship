...
$B_2(a)$ is the expected number of living granddaughters in a time-invariant female-only population\fcite{goodman_family_1974}:
...
$S^{old}(a)$ is the expected number of living older sisters in a time-invariant female-only population\fcite{goodman_family_1974}:
