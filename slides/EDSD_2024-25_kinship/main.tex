...
% Lectures: from Monday to Thursday, 10:00 â€“ 11:30\\
% Lectures: from Monday to Thursday, 10:00 â€“ 11:30\\
...
\href{mailto:martins@demogr.mpg.de}{martins@demogr.mpg.de}\\
...
Participants should install the following packages from CRAN:  \texttt{DemoKin}, \texttt{devtools}, and \texttt{tidyverse}.
...
\begin{itemize}
    \item A GitHub repository including the syllabus, slides, and other important materials: \url{https://github.com/amandamartinsal/EDSD_kinship_24-25}. Please make sure to download (clone) the \textbf{entire repository} into your computer!
    \item The website with the lab exercises: \url{https://amandamartinsal.github.io/EDSD_kinship_24-25/}.
\end{itemize}
...
Assignments (one per group) should be sent to \href{mailto:martins@demogr.mpg.de}{martins@demogr.mpg.de} \textbf{before midnight of Friday, November 22.} 
...
\subsection*{Monday, Nov 18: Introduction to kinship demography}
...
\subsection*{Tuesday, Nov 19: Mathematical models of kinship}
...
\subsection*{Wednesday, Nov 20: Extensions of the kinship model}
...
\subsection*{Thursday, Nov 21: Meet to work on assignment}
